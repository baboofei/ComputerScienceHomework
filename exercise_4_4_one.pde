...
int obj_elpse_one_pos_x;
int obj_elpse_one_pos_y;
int obj_elpse_two_pos_x;
int obj_elpse_two_pos_y;
int obj_elpse_three_pos_x;
int obj_elpse_three_pos_y;
int obj_elpse_four_pos_x;
int obj_elpse_four_pos_y;
...
void draw()
{
	...
	obj_elpse_one_pos_x = display_size_x / 4;
	obj_elpse_one_pos_y = display_size_y / 4;

	obj_elpse_two_pos_x = display_size_x / 4 * 3;
	obj_elpse_two_pos_y = display_size_y / 4;

	obj_elpse_three_pos_x = display_size_x / 4;
	obj_elpse_three_pos_y = display_size_y / 4 * 3;

	obj_elpse_four_pos_x = display_size_x / 4 * 3;
	obj_elpse_four_pos_y = display_size_y / 4 * 3;
